# Contributing to LAND Protocol

Thank you for your interest in improving the LAND Protocol. LAND Protocol is an open standard, and contributions from implementers, land professionals, legal experts, and technologists are what will make it better.

---

## How Changes Are Made

Changes to LAND Protocol are proposed through **LAND Improvement Proposals (LIPs)**. A LIP is a structured document that describes the rationale, scope, and technical detail of a proposed change to the protocol. All normative changes to the specification, schema, or hash algorithm must go through the LIP process.
...
Is this change backward compatible with existing LAND Protocol records? If not, explain what migration path implementers should follow.
...
| **Review** | The LAND Steering Committee marks the LIP as under formal review. Steering Committee members provide structured feedback within 30 days. |
...
Additional seats on the Steering Committee are available to organizations that implement LAND Protocol and commit to operating a publicly accessible verification endpoint for at least 12 months. To request a seat, open an issue with the subject line: "Steering Committee Seat Request: [Organization Name]".
...
**Justify new required fields carefully.** Requiring a new field makes every existing LAND Protocol record non-conformant until implementers update their data. The bar for adding a required field is high.
